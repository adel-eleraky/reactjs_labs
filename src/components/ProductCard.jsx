    ...
    return (
        <div className="featured-product border p-3 mb-3 position-relative rounded" >
            ...
            <div className="product-content">
                ...
                <button className="btn add-to-cart text-dark fw-bold w-100" style={{ backgroundColor: "rgb(5 72 25 / 52%)" }} ><i className="fa-solid fa-cart-plus me-2"></i>Add to Cart</button>
